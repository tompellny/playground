...
st.set_page_config(page_title="Home", page_icon=":material/insert_chart:")

st.title("Widget -- Antropic Light Themed")
...
with tabs[0]:
    ...
    st.page_link("pages/Widgets.py", label="Page link (this page)", icon=":material/my_location:")
    st.page_link("pages/Text.py", label="Page link (next page)", icon=":material/skip_next:")
